...
<div class="vipBox">
 <%@include file="vipLeft.jsp"%>
  <div class="vipRight">
    ...
    <form action="${pageContext.request.contextPath}/user/updatePass" class="registerform">
      <table class="grzx" width="705" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="90">新密码：</td>
          <td width="430"><input type="text" class="text inputxt" name="userPass" datatype="*6-16" nullmsg="请设置密码！" errormsg="密码范围在6~16位之间！" /></td>
