...
<div class="vipBox">
    ...
    <div class="vipRight">
        ...
        <form action="${pageContext.request.contextPath}/vip/updateAddress" method="post">
            <div class="address" style="display: block;">
                <input type="hidden" name="reciId" value="${reci.reciId}" />
                <div class="addList">
                    <label><span class="red">* </span>详细地址:</label>
                    <input type="text" name="reciAddr" value="${reci.reciAddr}"/>
                </div><!--addList-->

                <div class="addList">
                    <label><span class="red">* </span>收件人:</label>
                    <input type="text" name="reciName" value="${reci.reciName}"/>
                </div><!--addList-->
                <div class="addList">
                    <label><span class="red">* </span>手机号码:</label>
                    <input type="text" name="reciPhone" value="${reci.reciPhone}"/>
                </div><!--addList-->
                <div class="addList2">
...
<%--                <td><span class="green upd">--%>
<%--                                <a href="${pageContext.request.contextPath}/vipAddress/updateAddress">[修改]</a> </span></td>--%>
<%--            </tr>--%>
<%--            </c:forEach>--%>
<%--            </c:when>--%>
