          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[订单管理]-[订单查看]</td>
              </tr>
            </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <form action="${pageContext.request.contextPath}/order/list" name="searchForm" method="post">
        <!--带页号-->
         <input type="hidden" name="pageNum" value="1"/>
          <!--带状态条件-->
          <input type="hidden" name="statusId" value="${statusId}">
		 订单编号：<input name="orderId" type="text" value="${keyOrder.orderId}" size="16">
		 会员名：<input name="orderUser.userName" type="text" value="${keyOrder.orderUser.userName}" size="20">
		 收货人： <input name="orderName" type="text" value="${keyOrder.orderName}" size="20">
         联系电话： <input name="orderPhone" type="text" value="${keyOrder.orderPhone}" size="20">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <c:otherwise>
		  <c:forEach items="${pv.list}" var="order" varStatus="status">
          <tr>
            <td height="20" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center">
              <input type="checkbox" name="goodsIds" value="${order.orderId}" />
            </div></td>
            ...
            <td height="20" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE4"><img src="images/read.png" width="16" height="16" />
              <A href=${pageContext.request.contextPath}/order/details/${order.orderId}>查看</A>&nbsp; &nbsp;
